...
def main(unused_argv):
 ...
 # Log the values in the "Softmax" tensor with label "probabilities"
  ...
  train_data, train_cues, train_labels = read_data(data_set_directory,nm_start =0 , nm_end = 10000) 

  print("Doen reading Train data")
  ...
  eval_data, eval_cues, eval_labels = read_data(data_set_directory,nm_start =10000, nm_end = 20000)
