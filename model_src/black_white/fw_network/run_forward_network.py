...
def main(unused_argv):
 ...
 # Log the values in the "Softmax" tensor with label "probabilities"
  ...
  train_data, train_cues, train_labels = read_data(data_set_directory,"train",True)  # Returns np.array
  ...
  #'''
  eval_data, eval_cues, eval_labels = read_data(data_set_directory,"test",True)
